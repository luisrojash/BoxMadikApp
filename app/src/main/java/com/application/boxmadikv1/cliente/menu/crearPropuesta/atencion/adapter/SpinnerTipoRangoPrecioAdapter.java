...
public class SpinnerTipoRangoPrecioAdapter extends ArrayAdapter<String>{

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<TipoRangoPrecioUi> items;
    private final int mResource;

    public SpinnerTipoRangoPrecioAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        TipoRangoPrecioUi tipoDocumentoUi = (TipoRangoPrecioUi)items.get(position);
